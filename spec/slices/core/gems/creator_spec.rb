...
RSpec.describe Core::Services::Gems::Creator do
  let(:fake_gemspec_name_parser) { instance_double(Core::Services::Gems::GemspecNameParser) }
  let(:fake_rubygems_info_fetcher) { instance_double(Core::Services::Gems::RubygemsInfoFetcher) }
  let(:fake_gemspec_fetcher) { instance_double(Core::Services::Github::GemspecFetcher) }
  let(:fake_repos_list_fetcher) { instance_double(Core::Services::Github::ReposListFetcher) }
